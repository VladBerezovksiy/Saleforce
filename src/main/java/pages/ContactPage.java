...
public class ContactPage extends BasePage {
    ...
    private static final String BASE_URL = "https://sentrium.lightning.force.com/lightning/o/Contact/list?filterName=Recent";
    ...
    private static final By DETAILS_TAB_PANEL = By.xpath(
            "//div[@records-recordlayoutsection_recordlayoutsection and contains(@class,'slds-form')]" +
